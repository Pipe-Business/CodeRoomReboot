...
const EditCodePage: FC<Props> = () => {
    ...
    */
    ...
    }, [inputCategory, inputTitle, inputLanguage, inputPoint, inputGithubUrl,]);
        ...
        <MainLayout>
            ...
            <Card style={{marginTop: 64, padding: 32}}>
                ...
                <div style={{display: 'flex', width: '100%', justifyContent: 'end'}}>
                    <ColorButton type={'submit'} sx={{fontSize: '15', width: '194px'}}
                                 onClick={onSubmitCodeEditRequest}>수정완료</ColorButton>
                </div>
            </Card>
        </MainLayout>
    );
