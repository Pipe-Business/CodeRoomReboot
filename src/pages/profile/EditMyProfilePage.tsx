					...
					<FormWrapper onSubmit={onSubmitRegisterForm} style={{ marginTop: '24px' }}>
						<Stack spacing={4}>
							...
							<Box>
								...
								<Typography variant="body1" color="textSecondary" mt={2}>{state.userData?.email}</Typography>
							</Box>
							<Divider />
							<Box>
								<SectionTitle title='닉네임' />
								<Typography variant="body1" color="textSecondary" mt={2}>{state.userData?.nickname}</Typography>
							</Box>
							<Divider />
							<Box>
							...
							<Box display="flex" justifyContent="flex-end" mt={2}>
								<Button type="submit" variant="contained" color="primary" sx={{ fontSize: '16px', fontWeight: 'bold' }}>
									편집 완료
								</Button>
							</Box>
						</Stack>
