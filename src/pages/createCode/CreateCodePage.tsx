...
const CreateCodePage = () => {
    ...
    return <MainLayout>
        ...
        <Box sx={{marginTop: 4, marginBottom: 4}}>
            ...
            <Typography variant="h6" sx={{ color: '#333' }}>2. 관리자 collaborator 초대 필수 (관리자 id: team-code-room)</Typography>
        </Box>
        ...
        <TextField
            ...
            variant="outlined"
            error={!isValid && repo !== ''}
            helperText={!isValid && repo !== '' ? errorMessage : ""}
        ...
        >
            {isChecking ? '확인 중' : isValid ? '유효함': '유효하지 않음'}
        </Button>
        </div>
    </MainLayout>
}
