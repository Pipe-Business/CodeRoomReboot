...
const BuilderMenuListItemButton:FC<Props> = ({title,content,onClick, width, height}) => {
    return (
        <BuilderMenuListItemButtonContainer onClick={onClick} width={width} height={height}>
